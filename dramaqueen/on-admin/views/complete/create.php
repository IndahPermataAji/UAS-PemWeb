...
if($_POST){
	try {
		$sql = "INSERT INTO complete (id,judul,tahun,jumlah_ep,genre,negara,gambar) VALUES ('".$_POST['id']."','".$_POST['judul']."','".$_POST['tahun']."','".$_POST['jumlah_ep']."','".$_POST['genre']."','".$_POST['negara']."','".$_POST['gambar']."')";
	...
	window.location.href='index.php?page=complete/index';
	</script>";
}
